...
from mylib.runtime import configure_token, load_model_from_source, run_short_circuit_analysis  # noqa: E402
...
def main() -> None:
    ...
    output_dir = root / "results" / "skill-verification" / "short-circuit-analysis-direct-current"
    config = {
        "analysis": {
        ...
        "output": {
            "path": str(output_dir),
            "prefix": "short_circuit_direct_current",
